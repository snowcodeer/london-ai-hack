  ...
  const mockRequests = [
    {
      ...
      problem_photo_url: 'https://images.unsplash.com/photo-1585704032915-c3401922716b?w=800&q=80',
      ai_description: 'Leaking pipe under kitchen sink causing water damage to cabinet. Water is pooling underneath and the cabinet base is warping.',
    ...
    },
    {
      ...
      problem_photo_url: 'https://images.unsplash.com/photo-1621905251189-08b45d6a269e?w=800&q=80',
      ai_description: 'Faulty electrical outlet in bedroom - sparking when plugged in. Safety hazard that needs immediate attention.',
    ...
    },
    {
      ...
      problem_photo_url: 'https://images.unsplash.com/photo-1556911220-bff31c812dba?w=800&q=80',
      ai_description: 'Need help assembling IKEA furniture and mounting TV on wall. Have a desk, bookshelf, and 55-inch TV that need assembly and installation.',
    ...
    {
      id: 'req_mock_4',
      customer_id: 'customer_321',
      customer_name: 'James Wilson',
      customer_phone: '+44 20 7777 8888',
      customer_email: 'james@example.com',
      problem_photo_url: 'https://images.unsplash.com/photo-1626806787461-102c1bfaaea1?w=800&q=80',
      ai_description: 'Broken washing machine making loud grinding noises during spin cycle. Won\'t drain properly and leaving clothes soaking wet.',
      problem_category: 'appliance_repair',
      urgency: 'medium',
      location: JSON.stringify({
        ...
        state: 'Greater London',
        zip: 'N1 6NN',
        coordinates: { latitude: 51.5284, longitude: -0.0803 },
      }),
      customer_budget: 85,
      suggested_price: 80,
      floor_price: 70,
      matched_business_ids: JSON.stringify(['org_cityroad_appliances']),
      status: 'pending',
    },
    {
      id: 'req_mock_5',
      ...
      customer_phone: '+44 20 7999 0000',
      customer_email: 'olivia@example.com',
      problem_photo_url: 'https://images.unsplash.com/photo-1562259949-e8e7689d7828?w=800&q=80',
      ai_description: 'Living room wall needs repainting - water damage from ceiling leak has caused peeling and discoloration. About 20 square meters to cover.',
      problem_category: 'painting',
      urgency: 'medium',
      location: JSON.stringify({
        address: '67 Shoreditch High Street',
        city: 'London',
        state: 'Greater London',
        zip: 'E1 6JJ',
        coordinates: { latitude: 51.5242, longitude: -0.0768 },
      }),
      customer_budget: 250,
      suggested_price: 240,
      floor_price: 200,
      matched_business_ids: JSON.stringify(['org_clerkenwell_painting', 'org_hoxton_handyman']),
      status: 'pending',
    },
    {
      id: 'req_mock_6',
      customer_id: 'customer_987',
      customer_name: 'Mohammed Ali',
      customer_phone: '+44 20 7222 3333',
      customer_email: 'mohammed@example.com',
      problem_photo_url: 'https://images.unsplash.com/photo-1581858726788-75bc0f6a952d?w=800&q=80',
      ai_description: 'Kitchen cabinet door hinge broken and shelf sagging. Need carpenter to fix hinge and reinforce the shelf brackets.',
      problem_category: 'carpentry',
      urgency: 'low',
      location: JSON.stringify({
        address: '12 Leonard Street',
        city: 'London',
        state: 'Greater London',
        zip: 'EC2A 4RH',
        coordinates: { latitude: 51.5240, longitude: -0.0820 },
      }),
      customer_budget: 60,
      suggested_price: 55,
      floor_price: 45,
      matched_business_ids: JSON.stringify(['org_tech_city_carpentry', 'org_hoxton_handyman']),
      status: 'pending',
    },
    {
      id: 'req_mock_7',
      customer_id: 'customer_135',
      customer_name: 'Sarah Thompson',
      customer_phone: '+44 20 7444 5555',
      customer_email: 'sarah@example.com',
      problem_photo_url: 'https://images.unsplash.com/photo-1607400201515-c2c41c07d307?w=800&q=80',
      ai_description: 'Central heating not working properly. Radiators cold despite boiler running. Might need system bleeding or thermostat replacement.',
      problem_category: 'hvac',
      urgency: 'high',
      location: JSON.stringify({
        address: '89 City Road',
        city: 'London',
        state: 'Greater London',
        zip: 'EC1Y 1BD',
        coordinates: { latitude: 51.5275, longitude: -0.0889 },
      }),
      customer_budget: 150,
      suggested_price: 140,
      floor_price: 120,
      matched_business_ids: JSON.stringify(['org_shoreditch_hvac']),
      status: 'pending',
    },
    {
      id: 'req_mock_8',
      customer_id: 'customer_246',
      customer_name: 'Lucas Martinez',
      customer_phone: '+44 20 7666 7777',
      customer_email: 'lucas@example.com',
      problem_photo_url: 'https://images.unsplash.com/photo-1607472586893-edb57bdc0e39?w=800&q=80',
      ai_description: 'Bathroom sink completely blocked and not draining. Water backing up and standing in the basin. Tried plunger but issue persists.',
      problem_category: 'plumbing',
      urgency: 'medium',
      location: JSON.stringify({
        address: '34 Curtain Road',
        city: 'London',
        state: 'Greater London',
        zip: 'EC2A 3LT',
        coordinates: { latitude: 51.5250, longitude: -0.0795 },
      }),
      customer_budget: 75,
      suggested_price: 70,
      floor_price: 60,
    ...
    {
      id: 'req_mock_9',
      customer_id: 'customer_357',
      customer_name: 'Aisha Patel',
      customer_phone: '+44 20 7888 9999',
      customer_email: 'aisha@example.com',
      problem_photo_url: 'https://images.unsplash.com/photo-1615971677499-5467cbab01c0?w=800&q=80',
      ai_description: 'Need custom floating shelves installed in living room. Have 3 wooden shelves ready, just need professional mounting on plasterboard wall.',
      problem_category: 'carpentry',
      urgency: 'low',
      location: JSON.stringify({
        address: '56 Great Eastern Street',
        city: 'London',
        state: 'Greater London',
        zip: 'EC2A 3QR',
        coordinates: { latitude: 51.5248, longitude: -0.0805 },
      }),
      customer_budget: 90,
      suggested_price: 85,
      floor_price: 70,
